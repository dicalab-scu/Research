...
| Chinese Dialogue Dataset | Prepocessed dataset containing 240k sentences based on knowledge | [Download](https://github.com/wulaoshi/dialogue_train_data) |-|
| Medical Questions Generating Dataset| Preprocessed dataset containing 1.06 million sentences which can be applied to train pre-trained model generating medical questions in QA system | [Download](https://github.com/wulaoshi/Data-for-generating-medical-problems) |-|
